...
class PingMachine:
	...
	def answers(self):
		ip = socket.gethostbyname(self.ip) #To not send user input directly to a system call, lookup the ip for the hostname
...
if __name__ == '__main__':
	if len(sys.argv) != 4:
		print "Expected call 'python ping_lights.py <statefile> <ip/host> <telldus-id>'"
	else:
